...
MuseScore {
      version: "0.1.1"
      description: "Raise selection/selected note(s) up to a higher step. Steps sizes are determined by the fourth aux() declaration."
      menuPath: "Plugins.xen.Pitch Up (aux4)"
