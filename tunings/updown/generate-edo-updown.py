...
- USE_LIGATURES = True: the arrows are separate from the pythagorean accidentals 
                        (i.e. down & up appears as 'v' & '^')
- USE_LIGATURES = False: the arrows are ligatured with the pythagorean accidentals using the HEJI
